...
from browser_use.phone_controller.registry.views import (
    PhoneActionModel,
    ActionRegistry,
    RegisteredAction,
)
...
class Registry(Generic[Context]):
    ...
    async def execute_action(
        ...
        action_name: str,
        params: dict,
        phone: Optional[PhoneContext] = None,
        ...
        try:
            ...
            # Check if the action requires phone
            if "phone" in parameter_names and not phone:
                raise ValueError(
    ...
    def create_action_model(
        ...
        return create_model(
            "PhoneActionModel", __base__=PhoneActionModel, **fields
        )  # type:ignore
