...
if TYPE_CHECKING:
    from browser_use.mobile_agent.views import ActionResult, AgentStepInfo
...
class SystemPrompt:
    ...
    def _load_prompt_template(self) -> None:
        ...
        try:
            ...
            with (
                importlib.resources.files("browser_use.mobile_agent")
...
class AgentMessagePrompt:
    ...
    def get_user_message(self) -> HumanMessage:
        ...
        elements_text = json.dumps(self.state.touchable_elements)
        if self.step_info:
