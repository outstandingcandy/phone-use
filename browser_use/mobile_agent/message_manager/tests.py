...
from browser_use.mobile_agent.views import ActionResult
...
def test_token_overflow_handling_with_real_flow(
    ...
    for i in range(200):  # Simulate 40 steps of interaction
        ...
        from browser_use.mobile_agent.views import PhoneAgentBrain, PhoneAgentOutput
        from browser_use.phone_controller.registry.views import PhoneActionModel

        output = PhoneAgentOutput(
