...
from browser_use.mobile_agent.message_manager.views import MessageMetadata
from browser_use.mobile_agent.prompts import AgentMessagePrompt
...
class MessageManager:
    ...
    def add_state_message(
        self,
        state: PhoneState,
        result: Optional[List[PhoneActionResult]] = None,
        step_info: Optional[PhoneAgentStepInfo] = None,
        use_vision=True,
    ) -> None:
        """Add phone state as human message"""
    ...
    def add_model_output(self, model_output: PhoneAgentOutput) -> None:
